...
import com.yubo.firecontrol.base.App;
import com.yubo.firecontrol.utils.Constant;
import com.yubo.firecontrol.utils.GsonUtils;
...
public class RetrofitManager {
        ...
        if (mOkHttpClient == null) {
            synchronized (RetrofitManager.class) {
                if (mOkHttpClient == null) {
                    ...
                    builder.addHeaderParams("XMLHttpRequest","X-Requested-With");
                    builder.addHeaderParams("qjtoken", PreferencesUtil.getString(Constant.TOKEN));
    ...
    public static PatrolApiService getApiServiceLogin() {
        RxJavaCallAdapterFactory rxAdapter = RxJavaCallAdapterFactory.createWithScheduler(Schedulers.io());
