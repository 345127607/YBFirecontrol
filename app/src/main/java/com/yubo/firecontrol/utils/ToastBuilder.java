...
public class ToastBuilder {
    ...
    private static View setCustom(int msg, int flag) {
        View view = LayoutInflater.from(App.getInstance()).inflate(R.layout.toast_builder_layout, null);
        TextView msgTv = view.findViewById(R.id.toast_msg);
        ImageView img = view.findViewById(R.id.toast_img);
        msgTv.setText(msg);
        msgTv.setTextColor(ContextCompat.getColor(App.getInstance(),flag==1?R.color.colorPrimary:
